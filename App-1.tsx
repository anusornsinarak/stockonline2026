...
const App: React.FC = () => {
  ...
  const handleToggleMourningMode = () => {
      const newMourningMode = !isMourningMode;
      setIsMourningMode(newMourningMode);
      document.documentElement.classList.toggle('mourning-theme', newMourningMode);
      localStorage.setItem('mourningMode', String(newMourningMode));
  };
      ...
      {!session || !user ? (
        ...
        <>
          <Header
            ...
            isMourningMode={isMourningMode}
            onToggleMourningMode={handleToggleMourningMode}
          />
